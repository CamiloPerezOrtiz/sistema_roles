        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('registroRolPost') }}" method="POST">
                        @csrf
                        <div class="container">
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="acceso_completo_si" name="acceso_completo" class="custom-control-input" value="SI" @if(old('acceso_completo') == 'SI') checked @endif>
                                <label class="custom-control-label" for="acceso_completo_si">SI</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="acceso_completo_no" name="acceso_completo" class="custom-control-input" value="NO" @if(old('acceso_completo') == 'NO') checked @endif @if(old('acceso_completo') === null) checked @endif>
                            ...
                            @foreach ($permisos as $permiso)
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="customCheck_{{ $permiso->id }}" name="permisos[]" value="{{ $permiso->id }}" @if(is_array(old('permisos')) && in_array("$permiso->id", old('permisos'))) checked @endif>
